        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="card text-center">
                    ...
                    <div class="card-body">
                        <table id="table3rd" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Nama Ruangan</th>
                                ...
                                @foreach ($dataRuangan as $ruangan)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <button type="button"
                                                onclick="handleDelete('{{ route('ruangan.destroy', $ruangan->id) }}')"
                                                class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></button>
                                            <button type="button" class="btn btn-sm btn-info show-modal"
                                                data-toggle="modal" data-target="#showRuanganModal{{ $ruangan->id }}"><i
                                                    ...
                                                    @foreach ($ruangan->barangs as $barang)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <button type="button"
                                                                    onclick="handleDelete('{{ route('barang.destroy', $barang->id) }}')"
                                                                    class="btn btn-sm btn-danger"><i
                                                                        class="fas fa-trash"></i></button>
                                                                <button type="button"
                                                                    class="btn btn-sm btn-info show-modal"
                                                                    data-toggle="modal"
                                                                    data-target="#showBarangModal{{ $barang->id }}"><i
                                                                        class="fas fa-eye"></i></button>
                                                            </td>
                                                        </tr>

                                                        <!-- Modal Show Data Barang -->
                                                        <div class="modal fade m-0" id="showBarangModal{{ $barang->id }}"
                                    ...
                                    <div class="modal fade m-0" id="showRuanganModal{{ $ruangan->id }}"
