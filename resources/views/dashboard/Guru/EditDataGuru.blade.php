                            ...
                            <div class="col-md-6 row ">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" value="{{ $guru->id_guru }}" name="id_guru" class="form-control"
                                        id="exampleInputEmail1" placeholder="Masukkan Kode Guru...">
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="date" value="{{ $guru->tgl_lahir }}" name="tgl_lahir"
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" value="{{ $guru->no_telp }}" name="no_telp" class="form-control"
                                        id="exampleInputEmail1" placeholder="Masukkan No Telepon...">
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="agama" class="custom-select form-control">
                                        ...
                                        <option value="Kristen" {{ $guru->agama == 'Kristen' ? 'selected' : '' }}>Kristen
                                        </option>
                                        <option value="Hindu" {{ $guru->agama == 'Hindu' ? 'selected' : '' }}>Hindu
                                        </option>
                                        <option value="Budha" {{ $guru->agama == 'Budha' ? 'selected' : '' }}>Budha
                                        </option>
                                        <option value="Khongucu" {{ $guru->agama == 'Khongucu' ? 'selected' : '' }}>
                                            Khongucu</option>
                                    </select>
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="jenis_kelamin" class="custom-select form-control">
                                        ...
                                        <option value="Laki laki"
                                            {{ $guru->jenis_kelamin == 'Laki laki' ? 'selected' : '' }}>Laki laki</option>
                                        <option value="Perempuan"
                                            {{ $guru->jenis_kelamin == 'Perempuan' ? 'selected' : '' }}>Perempuan</option>
                                    </select>
                                </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="jabatan" class="custom-select form-control">
                                            ...
                                            <option value="Kepala Sekolah"
                                                {{ $guru->jabatan == 'Kepala Sekolah' ? 'selected' : '' }}>Kepala Sekolah
                                            </option>
                                            <option value="Guru Pelajaran"
                                                {{ $guru->jabatan == 'Guru Pelajaran' ? 'selected' : '' }}>Guru Pelajaran
                                            </option>
                                            <option value="Guru Wali Kelas"
                                                {{ $guru->jabatan == 'Guru Wali Kelas' ? 'selected' : '' }}>Guru wali kelas
                                            </option>
                                            <option value="Admin Tata Usaha"
                                                {{ $guru->jabatan == 'Admin Tata Usaha' ? 'selected' : '' }}>Admin Tata
                                                Usaha</option>
                                        </select>
                                    </div>
                                    <div class="form-group col-sm-6">
                                        ...
                                        <select name="kelas_id" class="custom-select form-control" id="kelas">
                                            @foreach ($kelas as $class)
                                                <option value="{{ $class->nama_kelas }}"
                                                    {{ $guru->kelas_id == $class->nama_kelas ? 'selected' : '' }}>
